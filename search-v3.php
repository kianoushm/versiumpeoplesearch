...
<div id="wrapper">
  ...
  <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 entry"><strong>State:</strong><input type="text" name="state" placeholder="eg. LA" /></div>
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 entry"><strong>Click to Submit </strong><input type="submit" value="Submit" class="submit-retry-btns"></div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <?php
				$numResults	= $data['datafinder']['num-results'];
				if ($numResults !=0){
				for ($i=0; $i<count($data['datafinder']['results']); $i++){
				$j=$i+1; //row count
				echo("<ul class='li-style'><li><h4>Result #".$j."</h4></li>");
				echo("<li><strong>First Name:</strong>".$data['datafinder']['results'][$i]['FirstName']."</li>");
				echo("<li><strong>Last Name:</strong>".$data['datafinder']['results'][$i]['LastName']."</li>");
				echo("<li><strong>Address:</strong>".$data['datafinder']['results'][$i]['Address']."</li>");
				echo("<li><strong>City:</strong>".$data['datafinder']['results'][$i]['City']."</li>");
				echo("<li><strong>State:</strong>".strtoupper($data['datafinder']['results'][$i]['State'])."</li>");
				echo("</ul>");
				} }else if($numResults =='0'){
				echo("<p id='noresult'>No Results Found!</p>");
				} else {
				echo("<p id='noresult'>Please Fill Out The Form!</p>");
				}
